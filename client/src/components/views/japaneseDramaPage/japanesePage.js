...
export default function JapanesePage() {
  ...
  const APIendpoint = `${DISCOVER_API_URL}&language=en-US&with_original_language=ja&page=1`;
  ...
  const handleLoadMoreButton = () => {
    ...
    let endpoint = '';
    setLoading(true);
    endpoint = `${DISCOVER_API_URL}&language=en-US&with_original_language=ja&page=${currentPage + 1}`;
